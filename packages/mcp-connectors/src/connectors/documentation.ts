...
export const DocumentationConnectorConfig = mcpConnectorConfig({
  ...
  setup: z.object({}),
  description:
    'Search the documentation of 30+ services including AI platforms (anthropic, openai), databases (pinecone, prisma), frameworks (astro, expo), and developer tools (cursor, zapier). This connector uses the llms-full.txt endpoint to get the full documentation in markdown format.',
  examplePrompt:
