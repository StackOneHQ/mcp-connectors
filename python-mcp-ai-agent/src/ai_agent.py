"""
AI Agent for natural language understanding and MCP tool orchestration
"""
import json
import logging
...
class AIAgent:
    """
    AI Agent that understands natural language and orchestrates MCP tool calls
    """
    ...
    async def _select_tools(self, user_query: str) -> Tuple[str, List[ToolCall]]:
        ...
        try:
            ...
            try:
                ...
                logger.error(f"Raw response: {repr(content)}")
